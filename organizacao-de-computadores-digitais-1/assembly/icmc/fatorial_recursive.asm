...
; -----------------------------------------------------------------
; fatorial: calcula recursivamente o fatorial de um numero
; Parametros
; 	r0: numero
; Retorno
; 	r7: resultado
...
fatorial:
	...
	loadn r1, #0 ; carrega 0 em r1 para fazer comparacao
	loadn r7, #1 ; carrega 1 em r7 (r7 retorna o resultado do fatorial)
	
	; Se nao eh zero: calcula o fatorial
	cmp r0, r1
	cne fatorial_recursive
	
	pop r1
	pop r0
	rts
	
	; Loop para as chamadas recursivas do fatorial
	fatorial_recursive:
		...
		call fatorial_recursive ; faz chamada a rotina
		
		inc r0         ; incrementa o numero
		mul r7, r7, r0 ; multiplica e acumula o resultado fatorial em r7
		rts            ; retorna a chamada

	; Quebra a recursao, dando inicio aos retornos
	fatorial_break:
		rts
